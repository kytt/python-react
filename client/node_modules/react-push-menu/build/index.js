...
var PushMenu = function (_Component) {
  ...
  function PushMenu(props) {
    ...
    _this.renderExpandLink = function (nodeData) {
      var ExpanderComponent = _this.props.expanderComponent || _chevronRight2.default;
    ...
    _this.renderSubMenu = function (nodeData) {
      ...
      var nodeChildren = node[propMap.childPropName];
      var BackComponent = _this.props.backComponent || _DefaultBackButton2.default;
      return _react2.default.createElement(
        'div',
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(BackComponent, { classPrefix: _this.classPrefix, data: nodeData })
        ),
        _react2.default.createElement(
          'ul',
          null,
...
PushMenu.propTypes = {
  ...
  type: _propTypes2.default.oneOf(['cover', 'overlap']),
  ...
  backComponent: _propTypes2.default.func,
  onMenuOpen: _propTypes2.default.func,
  onMenuClose: _propTypes2.default.func,
  expanderComponent: _propTypes2.default.func
};
